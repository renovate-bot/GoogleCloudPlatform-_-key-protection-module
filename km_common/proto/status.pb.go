...
// 	protoc        (unknown)
// source: km_common/proto/status.proto
...
func (Status) Descriptor() protoreflect.EnumDescriptor {
	return file_km_common_proto_status_proto_enumTypes[0].Descriptor()
}

func (Status) Type() protoreflect.EnumType {
	return &file_km_common_proto_status_proto_enumTypes[0]
}
...
func (Status) EnumDescriptor() ([]byte, []int) {
	return file_km_common_proto_status_proto_rawDescGZIP(), []int{0}
}

var File_km_common_proto_status_proto protoreflect.FileDescriptor

const file_km_common_proto_status_proto_rawDesc = "" +
	"\n" +
	"\x1ckm_common/proto/status.proto\x12\n" +
	"keymanager*\x8a\x03\n" +
	"\x06Status\x12\x16\n" +
...
var (
	...
	file_km_common_proto_status_proto_rawDescData []byte
)

func file_km_common_proto_status_proto_rawDescGZIP() []byte {
	file_km_common_proto_status_proto_rawDescOnce.Do(func() {
		file_km_common_proto_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_km_common_proto_status_proto_rawDesc), len(file_km_common_proto_status_proto_rawDesc)))
	})
	return file_km_common_proto_status_proto_rawDescData
}

var file_km_common_proto_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_km_common_proto_status_proto_goTypes = []any{
	(Status)(0), // 0: keymanager.Status
}
var file_km_common_proto_status_proto_depIdxs = []int32{
...
func init() { file_km_common_proto_status_proto_init() }
func file_km_common_proto_status_proto_init() {
	if File_km_common_proto_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_km_common_proto_status_proto_rawDesc), len(file_km_common_proto_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_km_common_proto_status_proto_goTypes,
		DependencyIndexes: file_km_common_proto_status_proto_depIdxs,
		EnumInfos:         file_km_common_proto_status_proto_enumTypes,
	}.Build()
	File_km_common_proto_status_proto = out.File
	file_km_common_proto_status_proto_goTypes = nil
	file_km_common_proto_status_proto_depIdxs = nil
}
